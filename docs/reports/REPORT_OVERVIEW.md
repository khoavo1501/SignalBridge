...
- **Cập nhật gần nhất:** 2026-09-20 — **chống lag chart slave + cửa sổ trượt realtime** ([PERF-chart-realtime.md](PERF-chart-realtime.md)) + **hướng dẫn setup & deploy** ([HUONG-DAN-SETUP-VA-DEPLOY.md](HUONG-DAN-SETUP-VA-DEPLOY.md)); trước đó M8 hoàn thành — **hết 9/9 milestone phase 1** ([M8-admin-ui.md](M8-admin-ui.md))
